...
public class BeanUtil {
	/**
	 * 如果bean是List接口的一个实例,就直接返回 如果bean不是List接口的一个实例,将其使用List对象将其包装
	 * 
	 * @param <T>
	 *            -- 多态类型
	 * @param bean
	...
	/**
	 * 如果bean是Map接口的一个实例,就直接返回 如果bean不是Map接口的一个实例,将返回一个空元素(map.size()等于0)的map对象
	 * 
	 * @param <K>
	 *            -- 多态map的key类型
	 * @param <T>
	 ...
	 * @return -- 排序后的map list
	 */
	public static List<Map<String, Object>> sort(List<Map<String, Object>> list, final String[] sortKeys,
			final boolean[] ascOrders) {
